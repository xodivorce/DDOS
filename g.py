...
TOKEN = '7599177087:AAH3-_pO4yZtzkapIA4ftqVLlQcSI4dY-kg'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002354137806
CHANNEL_ID = -1002354137806
error_channel_id = -1002354137806
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.reply_to(message, "*@xodivorce*", parse_mode='Markdown')
    else:
